...
public class Scene2DButtons extends ApplicationAdapter {
    ...
    public void create() {
        ...
        Skin mySkin = new Skin(Gdx.files.internal("src/main/resources/skins/glassy-ui.json"));
        ...
        button3.getStyle().imageUp = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("src/main/resources/assets/switch_off.png"))));
        button3.getStyle().imageDown = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("src/main/resources/assets/switch_on.png"))));
        ...
        button4.getStyle().imageUp = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("src/main/resources/assets/switch_off.png"))));
        button4.getStyle().imageDown = new TextureRegionDrawable(new TextureRegion(new Texture(Gdx.files.internal("src/main/resources/assets/switch_on.png"))));

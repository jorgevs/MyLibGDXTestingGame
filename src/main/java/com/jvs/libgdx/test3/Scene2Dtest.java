...
public class Scene2Dtest extends ApplicationAdapter {
    ...
    public void create() {
        ...
        Texture texture = new Texture(Gdx.files.absolute("src/main/resources/assets/image.jpg"));

        // create and add the Actors onto the Stage
    ...
    public void render() {
        ...
        // with Scene2D you don´t need to bother about rendering the Actors,
        // you just tell the application to render the Stage
        stage.act();
        stage.draw();
    }
}
